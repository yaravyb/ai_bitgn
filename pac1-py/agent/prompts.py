...
def build_validator_system() -> str:
    return (
        ...
        "specific file content, file existence, file dates, file counts, "
        "or any other file-metadata, escalate to OUTCOME_NONE_CLARIFICATION. "
        "An ungrounded answer cannot be approved regardless of how plausible "
        "it sounds — a file listing alone is not verification of file "
        "content.\n"
