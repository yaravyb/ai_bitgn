...
def build_executor_system() -> str:
    return (
        ...
        "a specific item (an article from a specific date, a contact with "
        "a specific email) and you cannot find an exact match, report "
        "OUTCOME_NONE_CLARIFICATION — not OUTCOME_OK with alternatives. "
        "This rule does NOT apply to tasks that ask you to FIX, UPDATE, "
        "CREATE, or MODIFY files — for those, take the action.\n"
        "</execution-process>\n"
        "\n"
        f"<outcome-codes>\n{OUTCOME_CODES_DOC}\n</outcome-codes>"
    )
