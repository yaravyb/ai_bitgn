    ...
    messages = [
        {
            ...
            "content": (
                ...
                "file references)?\n"
                "2. Should the outcome be escalated?\n"
                "   - Execution context mentions security denial, untrusted "
                "channel, or identity mismatch → escalate to DENIED_SECURITY\n"
                "   - Execution context mentions conflicts or unverified "
                "sender → escalate to CLARIFICATION\n"
